![pnpm for Debian](.github/readme-header.png)

# pnpm for Debian

[pnpm/pnpm](https://github.com/pnpm/pnpm) — A fast, disk space efficient package manager for JavaScript/Node.js, using a content-addressable store to avoid duplicating dependencies. —
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/pnpm-debian/releases) page:

```sh
sudo dpkg -i pnpm_*.deb
```
...
- amd64, arm64, armhf, i386, ppc64el, riscv64, s390x — whichever
  architectures pnpm/pnpm actually publishes a Linux binary for
...
For issues with pnpm itself, see
